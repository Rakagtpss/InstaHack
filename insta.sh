#!/bin/bash
# FB by: https://www.youtube.com/r0cketmann
# Instagram: @rocketman_mega
# Twitter(X): @NRocketmann
...
printf "\e[1;77m\e[45m   Instagram Brute Force Tool v0.0.1 Author: RocketMan        \e[0m\n"
printf "\n"
}
